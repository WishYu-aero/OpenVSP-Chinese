...
void SelectFileScreen::LoadFavsMenu()
{
    ...
    m_FavDirVec.clear();
    m_FavsMenuButton->add( vsp::l10n::Tr( "Add to Favorites" ) );
    m_FavsMenuButton->add( vsp::l10n::Tr( "Delete All Favorites" ), 0, nullptr, ( void* )0, FL_MENU_DIVIDER );
    m_FavsMenuButton->add( vsp::l10n::Tr( "Home" ) );
    m_FavsMenuButton->add( vsp::l10n::Tr( "VSP Path" ), 0, nullptr, ( void* )0, FL_MENU_DIVIDER );
