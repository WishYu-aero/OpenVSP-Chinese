...
ManageLightingScreen::ManageLightingScreen( ScreenMgr * mgr ) : BasicScreen( mgr, 250, 325, "Manage Lighting" )
{
    ...
    m_GenLayout.SetSameLineFlag( true );
        ...
        m_GenLayout.AddButton( m_LightButton0, vsp::l10n::Tr( "Light 0" ) );
        m_GenLayout.AddButton( m_LightButton1, vsp::l10n::Tr( "Light 1" ) );
    m_GenLayout.ForceNewLine();
        m_GenLayout.AddButton( m_LightButton2, vsp::l10n::Tr( "Light 2" ) );
        m_GenLayout.AddButton( m_LightButton3, vsp::l10n::Tr( "Light 3" ) );
    m_GenLayout.ForceNewLine();
        m_GenLayout.AddButton( m_LightButton4, vsp::l10n::Tr( "Light 4" ) );
        m_GenLayout.AddButton( m_LightButton5, vsp::l10n::Tr( "Light 5" ) );
    m_GenLayout.ForceNewLine();
        m_GenLayout.AddButton( m_LightButton6, vsp::l10n::Tr( "Light 6" ) );
        m_GenLayout.AddButton( m_LightButton7, vsp::l10n::Tr( "Light 7" ) );
    m_GenLayout.ForceNewLine();
    ...
    {
        snprintf( name, sizeof( name ), "%s %d", vsp::l10n::Tr( "Light" ), i );
