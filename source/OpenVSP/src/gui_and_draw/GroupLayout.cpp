...
VspButton* GroupLayout::AddParmButton( const char* label )
{
    ...
    button->copy_label( vsp::l10n::Tr( label ) );
...
void GroupLayout::AddButton( CheckButton& cbutton, const char* label, int used_w )
{
    ...
    flbutton->copy_label( vsp::l10n::Tr( label ) );
...
Fl_Box* GroupLayout::AddDividerBox( const string& text, int used_w )
{
    ...
    flbox->copy_label( vsp::l10n::Tr( text ).c_str() );
    m_Group->add( flbox );
...
void GroupLayout::AddLegendEntry( const string& text, Fl_Color c )
{
    ...
    button->copy_label( vsp::l10n::Tr( text ).c_str() );
    button->box( FL_THIN_UP_BOX );
    button->labelfont( FL_HELVETICA_BOLD );
    button->labelsize( 12 );
    button->labelcolor( FL_BLACK );
...
void GroupLayout::AddInputEvenSpacedVector(Input& start_input, Input& end_input, Input& npts_input,const char * label,const char * format)
{
    ...
    left_button_label = vsp::l10n::Tr( label );
...
void GroupLayout::AddColorPicker( ColorPicker& picker )
{
    ...
    colorButton->copy_label( vsp::l10n::Tr( "Color:" ) );
...
void GroupLayout::AddParmPicker( ParmPicker & parm_picker )
{
    ...
    button->copy_label( vsp::l10n::Tr( "Container" ) );
    button->box( FL_THIN_UP_BOX );
    button->labelfont( FL_HELVETICA_BOLD );
    button->labelsize( 12 );
    button->labelcolor( FL_BLACK );
    ...
    button->copy_label( vsp::l10n::Tr( "Group" ) );
    button->box( FL_THIN_UP_BOX );
    button->labelfont( FL_HELVETICA_BOLD );
    button->labelsize( 12 );
    button->labelcolor( FL_BLACK );
    ...
    button->copy_label( vsp::l10n::Tr( "Parm" ) );
    button->box( FL_THIN_UP_BOX );
    button->labelfont( FL_HELVETICA_BOLD );
    button->labelsize( 12 );
    button->labelcolor( FL_BLACK );
...
void GroupLayout::AddSkinHeader( SkinHeader & skin_header, bool addcontchoice )
{
    ...
    if( addcontchoice )
    {
        ...
        AddChoice( *cont_choice, vsp::l10n::Tr( "Enforce" ) );
    }
    else
    {
        gw += cw;
...
void GroupLayout::AddPCurveEditor( PCurveEditor& curve_editor )
{
    ...
    convbutton->copy_label( vsp::l10n::Tr( "Convert to:" ) );
    ...
    spbutton->copy_label( vsp::l10n::Tr( "Split" ) );
    ...
    splitpickbutton->copy_label( vsp::l10n::Tr( "Split Pick" ) );
    ...
    deletebutton->copy_label( vsp::l10n::Tr( "Del" ) );
    ...
    deletetoggle->copy_label( vsp::l10n::Tr( "Del Pick" ) );
