...
void DegenGeomScreen::GuiDeviceCallBack( GuiDevice* device )
{
    ...
    else if ( device == &m_Execute )
    {
        ...
        m_TextDisplay->buffer()->append( vsp::l10n::Tr( "Computing degenerate geometry...\n" ) );
        Fl::flush();
