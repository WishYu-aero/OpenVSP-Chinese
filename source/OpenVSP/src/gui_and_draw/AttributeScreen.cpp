...
AttributeExplorer::AttributeExplorer( ScreenMgr* mgr ) : BasicScreen( mgr, 800, 680, "Attribute Explorer", "AttributeExplorer.html" )
{
    ...
    m_AttrTypeSearchChoice.AddItem( vsp::l10n::Tr( NameValData::GetTypeName( vsp::BOOL_DATA , capitalize ) ), vsp::BOOL_DATA );
    m_AttrTypeSearchChoice.AddItem( vsp::l10n::Tr( NameValData::GetTypeName( vsp::INT_DATA, capitalize ) ), vsp::INT_DATA );
    m_AttrTypeSearchChoice.AddItem( vsp::l10n::Tr( NameValData::GetTypeName( vsp::DOUBLE_DATA, capitalize ) ), vsp::DOUBLE_DATA );
    m_AttrTypeSearchChoice.AddItem( vsp::l10n::Tr( NameValData::GetTypeName( vsp::STRING_DATA, capitalize ) ), vsp::STRING_DATA );
    m_AttrTypeSearchChoice.AddItem( vsp::l10n::Tr( NameValData::GetTypeName( vsp::PARM_REFERENCE_DATA, capitalize ) ), vsp::PARM_REFERENCE_DATA );
    m_AttrTypeSearchChoice.AddItem( vsp::l10n::Tr( NameValData::GetTypeName( vsp::VEC3D_DATA, capitalize ) ), vsp::VEC3D_DATA );
    m_AttrTypeSearchChoice.AddItem( vsp::l10n::Tr( NameValData::GetTypeName( vsp::INT_MATRIX_DATA, capitalize ) ), vsp::INT_MATRIX_DATA );
    m_AttrTypeSearchChoice.AddItem( vsp::l10n::Tr( NameValData::GetTypeName( vsp::DOUBLE_MATRIX_DATA, capitalize ) ), vsp::DOUBLE_MATRIX_DATA );
    m_AttrTypeSearchChoice.AddItem( vsp::l10n::Tr( NameValData::GetTypeName( vsp::ATTR_COLLECTION_DATA, capitalize ) ), vsp::ATTR_COLLECTION_DATA );
    ...
    m_AttrTypeChoice.AddItem( vsp::l10n::Tr( NameValData::GetTypeName( vsp::BOOL_DATA , capitalize ) ), vsp::BOOL_DATA );
    m_AttrTypeChoice.AddItem( vsp::l10n::Tr( NameValData::GetTypeName( vsp::INT_DATA, capitalize ) ), vsp::INT_DATA );
    m_AttrTypeChoice.AddItem( vsp::l10n::Tr( NameValData::GetTypeName( vsp::DOUBLE_DATA, capitalize ) ), vsp::DOUBLE_DATA );
    m_AttrTypeChoice.AddItem( vsp::l10n::Tr( NameValData::GetTypeName( vsp::STRING_DATA, capitalize ) ), vsp::STRING_DATA );
    m_AttrTypeChoice.AddItem( vsp::l10n::Tr( NameValData::GetTypeName( vsp::PARM_REFERENCE_DATA, capitalize ) ), vsp::PARM_REFERENCE_DATA );
    m_AttrTypeChoice.AddItem( vsp::l10n::Tr( NameValData::GetTypeName( vsp::VEC3D_DATA, capitalize ) ), vsp::VEC3D_DATA );
    m_AttrTypeChoice.AddItem( vsp::l10n::Tr( NameValData::GetTypeName( vsp::INT_MATRIX_DATA, capitalize ) ), vsp::INT_MATRIX_DATA );
    m_AttrTypeChoice.AddItem( vsp::l10n::Tr( NameValData::GetTypeName( vsp::DOUBLE_MATRIX_DATA, capitalize ) ), vsp::DOUBLE_MATRIX_DATA );
...
void AttributeExplorer::AttrTypeDispGroup( int attr_type, GroupLayout * group )
{
    ...
    string header_str = vsp::l10n::Tr( "Attribute Explorer" );
    ...
    if ( m_types_selected == 1 )
    {
        ...
        data_name = vsp::l10n::Tr( NameValData::GetTypeName( attr_type, cap, short_name ) );

        if ( data_name.size() )
        {
            data_name += " ";
        }
        data_name += vsp::l10n::Tr( "Data" );
    }
    else if ( m_types_selected > 1 )
    {
        data_name = vsp::l10n::Tr( "Multiple Data Types" );
    }
    else
    {
        data_name = vsp::l10n::Tr( "No Attributes Selected" );
    }
