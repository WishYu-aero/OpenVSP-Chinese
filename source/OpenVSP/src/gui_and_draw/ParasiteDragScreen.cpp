            ...
            "Parasite Drag", "", EXECUTE_LAYOUT_HEIGHT + 5, DRAG_TABLE_WIDTH + DRAG_TABLE_PERSISTENT_WIDTH + 10 )
{
    ...
    m_TurbCfEqnChoice.AddItem( "Explicit Fit of Spalding", vsp::CF_TURB_EXPLICIT_FIT_SPALDING );
    m_TurbCfEqnChoice.AddItem( "Explicit Fit of Spalding-Chi", vsp::CF_TURB_EXPLICIT_FIT_SPALDING_CHI );
    m_TurbCfEqnChoice.AddItem( "Explicit Fit of Schoenherr", vsp::CF_TURB_EXPLICIT_FIT_SCHOENHERR );
    m_TurbCfEqnChoice.AddItem( "Implicit Schoenherr", vsp::CF_TURB_IMPLICIT_SCHOENHERR );
    m_TurbCfEqnChoice.AddItem( "Implicit Karman-Schoenherr", vsp::CF_TURB_IMPLICIT_KARMAN_SCHOENHERR );
    m_TurbCfEqnChoice.AddItem( "Power Law Blasius", vsp::CF_TURB_POWER_LAW_BLASIUS );
    m_TurbCfEqnChoice.AddItem( "Power Law Prandtl Low Re", vsp::CF_TURB_POWER_LAW_PRANDTL_LOW_RE );
    m_TurbCfEqnChoice.AddItem( "Power Law Prandtl Medium Re", vsp::CF_TURB_POWER_LAW_PRANDTL_MEDIUM_RE );
    m_TurbCfEqnChoice.AddItem( "Power Law Prandtl High Re", vsp::CF_TURB_POWER_LAW_PRANDTL_HIGH_RE );
    m_TurbCfEqnChoice.AddItem( "Schlichting Compressible", vsp::CF_TURB_SCHLICHTING_COMPRESSIBLE );
    m_TurbCfEqnChoice.AddItem( "Schultz-Grunow Estimate of Schoenherr", vsp::CF_TURB_SCHULTZ_GRUNOW_SCHOENHERR );
    m_TurbCfEqnChoice.SetFlagByVal( vsp::CF_TURB_SCHULTZ_GRUNOW_SCHOENHERR, FL_MENU_DIVIDER );
    m_TurbCfEqnChoice.AddItem( "Roughness Schlichting Avg", vsp::CF_TURB_ROUGHNESS_SCHLICHTING_AVG );
    m_TurbCfEqnChoice.SetFlagByVal( vsp::CF_TURB_ROUGHNESS_SCHLICHTING_AVG, FL_MENU_DIVIDER );
    m_TurbCfEqnChoice.AddItem( "Roughness Schlichting Avg Compressible", vsp::CF_TURB_ROUGHNESS_SCHLICHTING_AVG_FLOW_CORRECTION );
    m_TurbCfEqnChoice.SetFlagByVal( vsp::CF_TURB_ROUGHNESS_SCHLICHTING_AVG_FLOW_CORRECTION, FL_MENU_DIVIDER );
    m_TurbCfEqnChoice.AddItem( "Heat Transfer White-Christoph", vsp::CF_TURB_HEATTRANSFER_WHITE_CHRISTOPH );
    ...
    m_TextBuffer->append( vsp::l10n::Tr( "-- Component Table Quantities -- \n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "S_wet \t\t : \t Wetted Area of Geometry, Calculated through DegenGeom \n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "L_ref \t\t : \t Reference Length of Geometry, Calculated through Length of Bounding Box in X direction or Chord on a Wing\n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "t/c or l/d \t : \t Thickness to Chord Ratio or Fineness Ratio, respectively \n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "FF Equation \t : \t Chosen Form Factor Equation for Internal Calculations \n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "FF \t\t : \t Form Factor of Specific Geometry \n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "Re \t\t : \t Reynolds Number for the component \n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "% Lam \t\t : \t % Laminar of Flow over Specific Geometry \n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "C_f \t\t : \t Friction Coefficient Calculated Using Specified Laminar and Turbulent Equation Choices \n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "Q \t\t : \t Interference Factor for Specific Geometry \n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "f \t\t : \t Flat Plat Drag \n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "C_D \t\t : \t Drag Coefficient for Specific Geometry \n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "% Total \t : \t Total Percentage of the Drag Contribution of Specific Geometry \n" ) );
    m_TextBuffer->append( "\n" );
    m_TextBuffer->append( vsp::l10n::Tr( "-- Excrescence Table Quantities -- \n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "Excres. Type \t : \t Chosen type of excrescence (Drag Counts, CD, % of C_D Geom, Drag Area ) \n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "Excres. Input \t : \t User Input Value for Excrescence of Described Type \n" ) );
    m_TextBuffer->append( "\n" );
    m_TextBuffer->append( vsp::l10n::Tr( "-- User Input Options -- \n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "Lam. Cf Eqn \t : \t Chosen Laminar Equation from Documented List at Link Below \n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "Turb. Cf Eqn \t : \t Chosen Turbulent Equation from Documented List at Link Below \n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "Spec. Method \t : \t Which Inputs Are to be Used to Determine Re/L and Mach \n" ) );
    snprintf( str, sizeof( str ),  "%s \t\t : \t %s \n", vsp::l10n::Tr( "Vinf" ), ParasiteDragMgr.m_Vinf.GetDescript().c_str() );
    m_TextBuffer->append( str );
    snprintf( str, sizeof( str ),  "%s \t : \t %s \n", vsp::l10n::Tr( "Altitude" ), ParasiteDragMgr.m_Hinf.GetDescript().c_str() );
    m_TextBuffer->append( str );
    snprintf( str, sizeof( str ),  "%s \t : \t %s \n", vsp::l10n::Tr( "Temperature" ), ParasiteDragMgr.m_Temp.GetDescript().c_str() );
    m_TextBuffer->append( str );
    snprintf( str, sizeof( str ),  "%s \t : \t %s \n", vsp::l10n::Tr( "Delta Temp." ), ParasiteDragMgr.m_DeltaT.GetDescript().c_str() );
    m_TextBuffer->append( str );
    snprintf( str, sizeof( str ),  "%s \t : \t %s \n", vsp::l10n::Tr( "Pressure" ), ParasiteDragMgr.m_Pres.GetDescript().c_str() );
    m_TextBuffer->append( str );
    snprintf( str, sizeof( str ),  "%s \t : \t %s \n", vsp::l10n::Tr( "Density" ), ParasiteDragMgr.m_Rho.GetDescript().c_str() );
    m_TextBuffer->append( str );
    snprintf( str, sizeof( str ),  "%s \t : \t %s \n", vsp::l10n::Tr( "Dynamic Visc." ), ParasiteDragMgr.m_DynaVisc.GetDescript().c_str() );
    m_TextBuffer->append( str );
    //sprintf(str, "Medium \t\t : \t %s \n", ParasiteDragMgr.m_MediumType.GetDescript().c_str());
    //m_TextBuffer->append(str);
    snprintf( str, sizeof( str ),  "%s \t\t : \t %s \n", vsp::l10n::Tr( "Re/L" ), ParasiteDragMgr.m_ReqL.GetDescript().c_str() );
    m_TextBuffer->append( str );
        const std::string mach_label = vsp::l10n::Tr( "Mach" );
        snprintf( str, sizeof( str ),  "%s \t\t : \t %s \n", mach_label.c_str(), ParasiteDragMgr.m_Mach.GetDescript().c_str() );
    m_TextBuffer->append( str );
    m_TextBuffer->append( "\n" );
    m_TextBuffer->append( vsp::l10n::Tr( "-- Input Unit Types -- \n" ) );
    ...
    snprintf( str, sizeof( str ),  "%s \t : \t %s \n", vsp::l10n::Tr( "Alt Units" ), temp.c_str() );
    m_TextBuffer->append( str );
    ...
    snprintf( str, sizeof( str ),  "%s \t : \t %s \n", vsp::l10n::Tr( "Length Units" ), temp.c_str() );
    m_TextBuffer->append( str );
    ...
    snprintf( str, sizeof( str ),  "%s \t : \t %s \n", vsp::l10n::Tr( "Vinf Units" ), temp.c_str() );
    m_TextBuffer->append( str );
    ...
    snprintf( str, sizeof( str ),  "%s \t : \t %s \n", vsp::l10n::Tr( "Temp Units" ), temp.c_str() );
    m_TextBuffer->append( str );
    ...
    snprintf( str, sizeof( str ),  "%s \t : \t %s \n", vsp::l10n::Tr( "Pres Units" ), temp.c_str() );
    m_TextBuffer->append( str );
    m_TextBuffer->append( "\n" );

    m_TextBuffer->append( vsp::l10n::Tr( "-- Component Labels Legend --\n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "(+) \t : \t Indicates there are additional components contributing to wetted area\n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "v \t : \t Indicates the geometry list has been expanded to show all surfaces associated with this geometry\n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "[ss] \t : \t Indicates a subsurface on the parented geometry\n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "[B] \t : \t Indicates the body components of a custom geometry\n" ) );
    m_TextBuffer->append( vsp::l10n::Tr( "[W] \t : \t Indicates the wing components of a custom geometry\n" ) );
    m_TextBuffer->append( "\n" );
...
void ParasiteDragScreen::GuiDeviceCallBack( GuiDevice* device )
{
    ...
    else if ( device == &m_export )
    {
        ...
        {
            vptr->setExportFileName( vsp::DRAG_BUILD_CSV_TYPE, m_ScreenMgr->FileChooser( "Select ParasiteBuildUp output file.", "*.csv", vsp::SAVE ) );
...
void ParasiteDragScreen::RebuildBuildUpTableLabels()
{
    ...
    m_CompLabel.GetFlButton()->copy_tooltip( vsp::l10n::Tr( "Geometry Name" ) );
    ...
    m_SwetUnitLabel.GetFlButton()->copy_tooltip( vsp::l10n::Tr( "Wetted Area of Geometry" ) );
    ...
    m_GroupedGeomLabel.GetFlButton()->copy_tooltip( vsp::l10n::Tr( "Option to blend individual component with ancestor" ) );
    ...
    m_FFEqnChoiceLabel.GetFlButton()->copy_tooltip( vsp::l10n::Tr( "Form Factor Equation Choice \n One per Geometry" ) );
    ...
    m_FFLabel.GetFlButton()->copy_tooltip( vsp::l10n::Tr( "Manual or Calculated Form Factor" ) );
    ...
    m_LrefUnitLabel.GetFlButton()->copy_tooltip( vsp::l10n::Tr( "Reference Length of Geometry" ) );
    ...
    m_FineRatorToCLabel.GetFlButton()->copy_tooltip( vsp::l10n::Tr( "Thickness over Chord \n \t or \n Fineness Ratio" ) );
    ...
    m_ReLabel.GetFlButton()->copy_tooltip( vsp::l10n::Tr( "Unitless Reynolds Number" ) );
    ...
    if ( ParasiteDragMgr.m_TurbCfEqnType() == vsp::CF_TURB_HEATTRANSFER_WHITE_CHRISTOPH )
    {
        ...
        m_TeTwLabel.GetFlButton()->copy_tooltip( vsp::l10n::Tr( "Freestream Temperature over Wall Temperature" ) );
        ...
        m_TawTwLabel.GetFlButton()->copy_tooltip( vsp::l10n::Tr( "Adiabatic Wall Temperature over Wall Temperature" ) );
    }
    ...
    m_PercLamLabel.GetFlButton()->copy_tooltip( vsp::l10n::Tr( "Percentage of Flow that is Turbulent \n Values should be input from 0 - 100" ) );
    ...
    m_CfLabel.GetFlButton()->copy_tooltip( vsp::l10n::Tr( "Friction Coefficient Calculated from Selected Equations" ) );
    ...
    m_QLabel.GetFlButton()->copy_tooltip( vsp::l10n::Tr( "Interference Factor" ) );
    ...
    m_fLabel.GetFlButton()->copy_tooltip( vsp::l10n::Tr( "Flat Plate Friction Drag" ) );
    ...
    m_CdLabel.GetFlButton()->copy_tooltip( vsp::l10n::Tr( "Coefficient of Parasite Drag Per Component" ) );

    m_ConstantTableLabelsLayout.AddButton( m_PercTotalLabel, "% Total" );
    m_PercTotalLabel.GetFlButton()->labelcolor( FL_BLACK );
    m_PercTotalLabel.GetFlButton()->copy_tooltip( vsp::l10n::Tr( "Percentage Total Contributed to Final Cd0" ) );
...
void ParasiteDragScreen::AddRoughnessLabel()
{
    ...
    m_RoughnessLabel.GetFlButton()->copy_tooltip( vsp::l10n::Tr( "Roughness Height" ) );
}
