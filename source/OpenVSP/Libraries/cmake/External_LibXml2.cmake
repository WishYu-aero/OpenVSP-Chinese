...
if(WIN32)
  ...
  # configure.js writes this prefix directly into an nmake file.  cmd.exe
  # requires a native Windows path when it is followed by a backslash.
...
execute_process(
  COMMAND nmake /f Makefile.msvc PREFIX=${libxml2_install_win} install
  WORKING_DIRECTORY \"${libxml2_source}/win32\"
  )")
